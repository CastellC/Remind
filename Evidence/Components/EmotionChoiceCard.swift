...
/// Accessible choice control for selecting an `Emotion`.
struct EmotionChoiceCard: View {
    let emotion: Emotion
    ...
    var body: some View {
        ...
        .accessibilityHint(accessibilityHintText ?? "Double tap to select this feeling")
...
#Preview {
    VStack(spacing: 8) {
        EmotionChoiceCard(emotion: .anxious, isSelected: true) {}
        EmotionChoiceCard(emotion: .lonely) {}
    }
    .padding()
}
